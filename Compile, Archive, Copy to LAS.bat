...
copy "C:\dev\VS Code Projects\RST-Static-Lib\libRST.a" "C:\dev\VS Code Projects\Life-Application-Suite\lib"
copy "C:\dev\VS Code Projects\RST-Static-Lib\src\RST.h" "C:\dev\VS Code Projects\Life-Application-Suite\include\RST"